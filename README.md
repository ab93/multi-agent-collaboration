...
This project uses a modified version of the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
2. Place the file inside the `multi-agent-collaboration` repository, e.g. in Linux your project directory will look like this:
...
- Run `jupyter-notebook src/collab.ipynb` from the base directory after following the steps in the "Getting Started" section.
